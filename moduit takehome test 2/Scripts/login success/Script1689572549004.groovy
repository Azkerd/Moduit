...
WebUI.getText(findTestObject('Object Repository/Page_Swag Labs/input_Swag Labs_user-name'))
...
WebUI.getText(findTestObject('Object Repository/Page_Swag Labs/div_Password for all userssecret_sauce'))
